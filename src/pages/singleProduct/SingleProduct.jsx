    ...
    <>
      {loading ? (
        <div className="flex h-[70vh] items-center justify-center">
          <FaSpinner className="animate-spin text-6xl text-green-900" />
        </div>
      ) : (
        <div className="grid md:grid-cols-2">
          ...
          <div className="p-6">
            ...
            <h3 className="md:text-xl text-lg text-slate-500 my-2">
            ...
            <div className="rounded-2xl w-36 flex justify-between text-2xl md:text-4xl my-3 overflow-hidden">
              <button
                className="bg-slate-300 px-3 cursor-pointer"
            ...
            <div className="flex gap-4 my-7 text-base md:text-2xl">
              <button className="border rounded-full px-3 py-1 bg-green-900 text-white">
                Buy Now
              </button>
              <button className="border border-green-900 rounded-full px-3 py-1">
                Add to Cart
              </button>
            </div>
          </div>
